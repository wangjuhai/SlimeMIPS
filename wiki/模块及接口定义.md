...
- 输出信号说明
	|名称			|去向		|位宽|描述			|
	|:---:|:---:|:---:|:---:|
	|inst_		|ID.ID_MUX1._linst/ID.ID_CU._inst/ID.ID_EXT._imm26/ID.RF._rs_addr/ID.RF._rt_addr/EX.EX_MUX1._inst|32|即将进入译码阶段的指令			|
...
- 选择信号说明
	|名称			|来源			|位宽|描述			|
	|:---:|:---:|:---:|:---:|
	| _sel_data1 | ID.ID_CU.sel_data1_ | 2 | 选择alu的原操作数1	|
- 输入信号说明
	|名称			|来源		|位宽|描述			|
	|:---:|:---:|:---:|:---:|
	| _32constant0 | 常数生成器       | 32 | 32位的0                    |
