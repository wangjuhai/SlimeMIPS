...
- 输出信号说明
	|名称			|去向		|位宽|描述			|
	|:---:|:---:|:---:|:---:|
	|inst_		|ID.ID_MUX1._linst/ID.ID_CU._inst/ID.ID_EXT._imm26/ID.RF._rs_addr/ID.RF._rt_addr|32|即将进入译码阶段的指令			|
	|pc_		|ID.ID_MUX1._lpc/ID.ID_EXT._pc|32|即将进入译码阶段的指令的地址					|
