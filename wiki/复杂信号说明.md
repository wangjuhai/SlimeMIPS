...
- 详细描述
	|宏定义|操作描述|对应指令|
	|:---:|:----:|:---:|
	|ID_MUX2_NOP	|选择_32constant0	||
	|ID_MUX2_32CONSTANT26	|选择_32constant16	|LUI|
	|ID_MUX2_IMM32			|选择_imm32			|SLL,SRA,SRL|
	|ID.MUX2_RS_DATA		|选择_rs_data		|ADD,ADDU,SUB,SUBU,SLT,SLTU,DIV,DIVU,MULT,MULTU,AND,NOR,OR,XOR,SLLV,SRAV,SRLV,ADDI,ADDIU,SLTI,SLTIU,ANDI,ORI,XORI,LB,LBU,LH,LHU,LW,SB,SH,SW,BEQ,BNE,BGEZ,BGTZ,BLEZ,BLTZ,BGEZAL,BLTZAL,MTHI,MTLO|
...
- 详细描述
	|宏定义|操作描述|对应指令|
	|:---:|:----:|:---:|
	|ID_MUX3_NOP	|选择_32constant0	|BGEZ,BGTZ,BLEZ,BLTZ,BGEZAL,BLTZAL,J,JAL,JR,JALR,MTHI,MTLO|
	|ID_MUX3_IMM32	|选择_imm32			|ADDI,ADDIU,SLTI,SLTIU,ANDI,ORI,XORI,LB,LBU,LH,LHU,LW,SB,SH,SW|
	|ID_MUX3_RT_DATA	|选择_rt_data	|ADD,ADDU,SUB,SUBU,SLT,SLTU,DIV,DIVU,MULT,MULTU,AND,NOR,OR,XOR,SLLV,SRAV,SRLV,LUI,SLL,SRA,SRL,BEQ,BNE,|
